...
class EmbedHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        embed.set_footer(text=self.get_ending_note(), icon_url="https://cdn.discordapp.com/avatars/715735496940060712/0064a5c092ed9d0dd5d46de41c5a3138.png?size=1024")
    ...
    async def send_group_help(self, group):
        embed = discord.Embed(title=f'Command - {group.qualified_name}', colour=self.COLOUR)
        if group.help:
            embed.description = f'{self.clean_prefix}{group.qualified_name} {group.help}'
